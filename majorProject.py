...
filepath = "E:/Master Course/Fourth_Semester_2021/Geospatial Programming/Assessment/MajorProject/"

# Modify the forest Year according to the data file
StartYear = "forest_2010.tif"   # e.g forest_2015.tif, forest_2020.tif
EndYear = "forest_2017.tif"     # e.g forest_2015.tif, forest_2020.tif
...
# create new folder Suitability output 
...
### clip all landcover into district  
...
# clip all rasters into district
suffix = "_clip"
...
stats = outputfile.dataProvider().bandStatistics(1, QgsRasterBandStats.All)

class_break = (stats.maximumValue)/3   # three categories are defined
...
table = [class_1,class_2,1,class_2,class_3,2, class_3,class_max,3]
...
# calculate Suitability_class for each rfppf
